...
const Intro = forwardRef<HTMLElement>((props, ref) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-linear-to-tr from-foreground/2 to-transparent rounded-full blur-3xl animate-[smoothPulse_6s_ease-in-out_infinite]"
                style={{ animationDelay: '3s' }}></div>

            <div className="grid lg:grid-cols-5 gap-16 sm:gap-20 w-full relative z-10">
                <div className="lg:col-span-3 space-y-6 sm:space-y-8">
                    {/* Greeting */}
                    <div className="opacity-0 translate-y-4 animate-[fadeInUp_0.5s_cubic-bezier(0.16,1,0.3,1)_0.1s_forwards]">
                        ...
                        <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-2">
                            <div className="group flex items-center gap-2.5 px-4 py-2 rounded-full border border-green-500/20 bg-green-500/5 hover:bg-green-500/10 transition-all duration-300">
                                <div className="relative">
                                    ...
                                    <div className="absolute inset-0 w-2 h-2 bg-green-500 rounded-full animate-[gentlePing_2s_ease-in-out_infinite] opacity-75"></div>
                                </div>
                ...
                <div className="lg:col-span-2 flex flex-col sm:justify-start justify-center space-y-10 sm:space-y-12 mt-8 lg:mt-0">
                    ...
                    {/* Focus Skills */}
                    <div className="opacity-0 translate-y-6 animate-[fadeInUp_0.6s_cubic-bezier(0.16,1,0.3,1)_1.1s_forwards]">
                        <div className="space-y-5">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {intro.focusSkills.map((skill, index) => (
                                    <span
                                        key={skill}
                                        className="px-3 py-1.5 text-xs text-foreground/80 rounded-full bg-muted/30 border border-border/40 hover:bg-muted/50 hover:text-foreground hover:scale-105 transition-all duration-300 cursor-default opacity-0 animate-[fadeIn_0.4s_cubic-bezier(0.16,1,0.3,1)_forwards]"
